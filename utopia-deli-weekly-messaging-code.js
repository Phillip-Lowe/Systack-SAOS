...
// Compose Messages — Code Node
// Email-only active. SMS output preserved for Twilio re-activation.
...
<!-- Logo Header -->
<tr>
<td style="background:${C.burgundy};padding:24px;text-align:center;">
<img src="${images.logo}" alt="The Utopia Deli" style="height:56px;display:block;margin:0 auto;">
</td>
</tr>
